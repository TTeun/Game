...
namespace View {
    Window::Window(uint width, uint height, const char * title, bool showFrameRate)
    ...
    void Window::setShowFrameRate(bool showFrameRate)
    {
        m_showFrameRate = showFrameRate;
    }

    float Window::getDtInSeconds() const
    {
    ...
    void Window::drawLine(const sf::Vector2f & p1, const sf::Vector2f & p2, const sf::Color & color)
    {
