...
Model::Entities::TerrainBlock::TerrainBlock(const size_t id, float width, float height, const sf::Vector2f &position)
        : Physics::Object(Model::Shapes::ColoredRectangle({width, height}, position)), m_id(id) {
}
...
Model::Entities::TerrainBlock::TerrainBlock(size_t id, Model::Shapes::ColoredRectangle &&coloredRectangle)
