...
void View::DrawInterface::draw(const Model::Entities::Water & water, View::Window & window)
{
...
void View::DrawInterface::draw(const Model::DataStructures::RectGraph & rectGraph, View::Window & window)
{
    ...
    for (const auto & edge : edges) {
        window.drawLine(
            rectangles.at(edge.first.first).getCenter(), rectangles.at(edge.first.second).getCenter(), {100, 100, 100});
    }
}